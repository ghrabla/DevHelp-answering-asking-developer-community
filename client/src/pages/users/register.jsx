...
import { register, reset } from "../../services/authUser/authSlice";
        ...
        <div class="h-screen md:flex flex-row-reverse">
            ...
            <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
                <form class="bg-white" onSubmit={onSubmit}>
                    <h1 class="text-gray-800 font-bold text-2xl mb-1">Hello developer!</h1>
                    <p class="text-sm font-normal text-gray-600 mb-7">Let's start it</p>
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input class="pl-2 outline-none border-none" type="text" name="fullname"
                            value={fullname}
